...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--dataset', default='TissueNet',
                             help='coco | kitti | coco_hp | pascal | TicueNet')
    self.parser.add_argument('--exp_id', default='TissueNet_ctdet')
    ...
    # system
    self.parser.add_argument('--gpus', default='5',
    ...
    self.parser.add_argument('--K', type=int, default=999,
                             help='max number of output objects.') 
    self.parser.add_argument('--not_prefetch_test', action='store_true',
                             help='not use parallal data pre-processing.',default=False)
  ...
  def init(self, args=''):
    default_dataset_info = {
      'ctdet': {'default_resolution': [256, 256], 'num_classes': 1,
                'mean': [0.22207777, 0.22207777, 0.22207777], 'std': [0.25970829, 0.25970829, 0.25970829],
                'dataset': 'TissueNet'},
